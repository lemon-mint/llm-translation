...
package translatev1beta1connect

import (
	connect "connectrpc.com/connect"
	context "context"
	errors "errors"
	v1beta1 "github.com/lemon-mint/llm-translation/proto/translate/v1beta1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	TranslationServiceName = "translate.v1beta1.TranslationService"
)
...
const (
	...
	// Healthz RPC.
	TranslationServiceHealthzProcedure = "/translate.v1beta1.TranslationService/Healthz"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	translationServiceServiceDescriptor       = v1beta1.File_translate_v1beta1_translate_proto.Services().ByName("TranslationService")
	translationServiceHealthzMethodDescriptor = translationServiceServiceDescriptor.Methods().ByName("Healthz")
)

// TranslationServiceClient is a client for the translate.v1beta1.TranslationService service.
...
// NewTranslationServiceClient constructs a client for the translate.v1beta1.TranslationService
...
// Healthz calls translate.v1beta1.TranslationService.Healthz.
...
// TranslationServiceHandler is an implementation of the translate.v1beta1.TranslationService
// service.
...
func NewTranslationServiceHandler(svc TranslationServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/translate.v1beta1.TranslationService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedTranslationServiceHandler) Healthz(context.Context, *connect.Request[v1beta1.HealthzRequest]) (*connect.Response[v1beta1.HealthzResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("translate.v1beta1.TranslationService.Healthz is not implemented"))
}
